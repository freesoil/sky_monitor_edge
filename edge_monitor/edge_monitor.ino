...
const char* UPLOAD_URL = "http://192.168.1.47:8000/upload"; // Replace with your upload endpoint
...
unsigned long lastCaptureTime = 0; // This will trigger recording immediately
